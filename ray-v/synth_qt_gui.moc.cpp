...
**
** Created: Tue Jan 31 19:31:17 2012
...
static const char qt_meta_stringdata_SynthGUI[] = {
    ...
    "setPitchEnvTime(float)\0setPitchEnvAmt(float)\0"
    ...
    "pitchEnvTimeChanged(int)\0"
    "pitchEnvAmtChanged(int)\0programChanged(int)\0"
    "programSaved()\0test_press()\0test_release()\0"
    "oscRecv()\0"
};
