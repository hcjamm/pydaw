...
#define LMS_PLUGIN_LONG_NAME "LMS Filter (Powered by LibModSynth)";  //Please keep the (Powered by LibModSynth) tag, it helps further the goal of promoting Linux DSSI plugins
