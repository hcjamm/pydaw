...
class transport_widget:
    ...
    def __init__(self):
        ...
        self.stop_button.setStyleSheet("QRadioButton::indicator{width:48px;height:48px; border-radius: 10px;} QRadioButton::indicator::unchecked{image: url(pydaw/stop-off.png);}QRadioButton::indicator::checked{image: url(pydaw/stop-off.png);}")
