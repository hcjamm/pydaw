...
class song_editor:
    ...
    def __init__(self):
        ...
        self.table_widget.setMinimumHeight(105)
        self.table_widget.setMaximumHeight(105)
...
class transport_widget:
    ...
    def __init__(self):
        ...
        self.play_button.setStyleSheet("QRadioButton::indicator{width:48px;height:48px;} QRadioButton::indicator::unchecked{image: url(pydaw/play-off.png);}QRadioButton::indicator::checked{image: url(pydaw/play-on.png);}")        
        self.play_button.clicked.connect(self.on_play)
        self.hlayout1.addWidget(self.play_button)
        self.stop_button = QtGui.QRadioButton()
        self.stop_button.setStyleSheet("QRadioButton::indicator{width:48px;height:48px;} QRadioButton::indicator::unchecked{image: url(pydaw/stop-off.png);}QRadioButton::indicator::checked{image: url(pydaw/stop-off.png);}")
        self.stop_button.clicked.connect(self.on_stop)
        self.hlayout1.addWidget(self.stop_button)
        self.rec_button = QtGui.QRadioButton()
        self.rec_button.setStyleSheet("QRadioButton::indicator{width:48px;height:48px;} QRadioButton::indicator::unchecked{image: url(pydaw/rec-off.png);}QRadioButton::indicator::checked{image: url(pydaw/rec-on.png);}")
