...
$deps_ubuntu = "sudo apt-get install -y liblo-dev libasound2-dev g++ libqt4-dev libjack-jackd2-dev libsndfile1-dev libtool autoconf gdb debhelper dh-make build-essential automake autoconf libtool qjackctl alsa-utils python-liblo python-qt4 libsdl1.2-dev ffado-mixer-qt4 ffado-tools ffado-dbus-server";

$deps_debian = "sudo apt-get install -y liblo-dev libasound2-dev libqt4-dev libjack-dev libsndfile1-dev automake autoconf libtool qjackctl alsa-utils python-liblo python-qt4 libsdl1.2-dev ffado-mixer-qt4 ffado-tools ffado-dbus-server";
