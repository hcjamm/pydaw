    ...
    m_ready(false)
{
    ...
    m_fx1 = new LMS_multieffect(this, QString("FX1"), f_info, LMS_FX1_KNOB1, LMS_FX1_KNOB2, LMS_FX1_KNOB3, LMS_FX1_COMBOBOX);
    connect(m_fx1->lms_knob1->lms_knob,  SIGNAL(valueChanged(int)), this, SLOT(fx1knob1Changed(int)));
    connect(m_fx1->lms_knob2->lms_knob,  SIGNAL(valueChanged(int)), this, SLOT(fx1knob2Changed(int)));
    connect(m_fx1->lms_knob3->lms_knob,  SIGNAL(valueChanged(int)), this, SLOT(fx1knob3Changed(int)));
...
void SynthGUI::setFX1knob1(float val){ lms_set_value(val, m_fx1->lms_knob1); }
void SynthGUI::setFX1knob2(float val){ lms_set_value(val, m_fx1->lms_knob2); }
void SynthGUI::setFX1knob3(float val){ lms_set_value(val, m_fx1->lms_knob3); }
...
void SynthGUI::fx1knob1Changed(int value){ lms_value_changed(value, m_fx1->lms_knob1); }
void SynthGUI::fx1knob2Changed(int value){ lms_value_changed(value, m_fx1->lms_knob2); }
void SynthGUI::fx1knob3Changed(int value){ lms_value_changed(value, m_fx1->lms_knob3); }
...
{        
    switch (a_port) {
    case LMS_FX1_KNOB1:
        return m_fx1->lms_knob1->lms_get_value();
    case LMS_FX1_KNOB2:
        return m_fx1->lms_knob2->lms_get_value();
    case LMS_FX1_KNOB3:
        return m_fx1->lms_knob3->lms_get_value();
    case LMS_FX1_COMBOBOX:
        return m_fx1->lms_combobox->lms_get_value();
    default:
#ifdef LMS_DEBUG_MODE_QT
