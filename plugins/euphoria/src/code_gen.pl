...
$mod_matrix_first_control_port = 38;
...
my $port_name = "LMS_PFXMATRIX_SRC$i" . "DST$i2" . "CTRL$i3";
...
my $lc_name = "pfxmatrix_src$i" . "dst$i2" . "ctrl$i3";
...
$connect_ports .= "case $port_name: $lc_name = data; break;\n";
$ladspa_data .= "LADSPA_Data *$lc_name;\n";
