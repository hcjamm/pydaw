...
#define LMS_LAST_CONTROL_PORT 34  //TODO:  Is this obsolete now with the below?
#define LMS_COUNT 35 /* must be 1 + highest value above CHANGE THIS IF YOU ADD OR TAKE AWAY ANYTHING*/
