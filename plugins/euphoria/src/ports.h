...
#define LMS_SAMPLE_PITCH_PORT_RANGE_MAX     (LMS_SAMPLE_PITCH_PORT_RANGE_MIN + EUPHORIA_MAX_SAMPLE_COUNT)
...
#define LMS_PLAY_PITCH_LOW_PORT_RANGE_MAX   (LMS_PLAY_PITCH_LOW_PORT_RANGE_MIN + EUPHORIA_MAX_SAMPLE_COUNT)
...
#define LMS_PLAY_PITCH_HIGH_PORT_RANGE_MAX  (LMS_PLAY_PITCH_HIGH_PORT_RANGE_MIN + EUPHORIA_MAX_SAMPLE_COUNT)

/*The range of ports for sample volume*/
#define LMS_SAMPLE_VOLUME_PORT_RANGE_MIN    LMS_PLAY_PITCH_HIGH_PORT_RANGE_MAX
#define LMS_SAMPLE_VOLUME_PORT_RANGE_MAX    (LMS_SAMPLE_VOLUME_PORT_RANGE_MIN + EUPHORIA_MAX_SAMPLE_COUNT)

#define LMS_SAMPLE_START_PORT_RANGE_MIN    LMS_SAMPLE_VOLUME_PORT_RANGE_MAX
#define LMS_SAMPLE_START_PORT_RANGE_MAX    (LMS_SAMPLE_START_PORT_RANGE_MIN + EUPHORIA_MAX_SAMPLE_COUNT)

#define LMS_SAMPLE_END_PORT_RANGE_MIN    LMS_SAMPLE_START_PORT_RANGE_MAX
#define LMS_SAMPLE_END_PORT_RANGE_MAX    (LMS_SAMPLE_END_PORT_RANGE_MIN + EUPHORIA_MAX_SAMPLE_COUNT)

#define LMS_SAMPLE_VEL_SENS_PORT_RANGE_MIN    LMS_SAMPLE_END_PORT_RANGE_MAX
#define LMS_SAMPLE_VEL_SENS_PORT_RANGE_MAX    (LMS_SAMPLE_VEL_SENS_PORT_RANGE_MIN + EUPHORIA_MAX_SAMPLE_COUNT)

#define LMS_SAMPLE_VEL_LOW_PORT_RANGE_MIN    LMS_SAMPLE_VEL_SENS_PORT_RANGE_MAX
#define LMS_SAMPLE_VEL_LOW_PORT_RANGE_MAX    (LMS_SAMPLE_VEL_LOW_PORT_RANGE_MIN + EUPHORIA_MAX_SAMPLE_COUNT)

#define LMS_SAMPLE_VEL_HIGH_PORT_RANGE_MIN    LMS_SAMPLE_VEL_LOW_PORT_RANGE_MAX
#define LMS_SAMPLE_VEL_HIGH_PORT_RANGE_MAX    (LMS_SAMPLE_VEL_HIGH_PORT_RANGE_MIN + EUPHORIA_MAX_SAMPLE_COUNT)

#define LMS_PITCH_PORT_RANGE_MIN    LMS_SAMPLE_VEL_HIGH_PORT_RANGE_MAX
#define LMS_PITCH_PORT_RANGE_MAX    (LMS_PITCH_PORT_RANGE_MIN + EUPHORIA_MAX_SAMPLE_COUNT)

#define LMS_TUNE_PORT_RANGE_MIN    LMS_PITCH_PORT_RANGE_MAX
#define LMS_TUNE_PORT_RANGE_MAX    (LMS_TUNE_PORT_RANGE_MIN + EUPHORIA_MAX_SAMPLE_COUNT)

#define LMS_SAMPLE_INTERPOLATION_MODE_PORT_RANGE_MIN    LMS_TUNE_PORT_RANGE_MAX
#define LMS_SAMPLE_INTERPOLATION_MODE_PORT_RANGE_MAX    (LMS_SAMPLE_INTERPOLATION_MODE_PORT_RANGE_MIN + EUPHORIA_MAX_SAMPLE_COUNT)

#define LMS_SAMPLE_LOOP_START_PORT_RANGE_MIN    LMS_SAMPLE_INTERPOLATION_MODE_PORT_RANGE_MAX
#define LMS_SAMPLE_LOOP_START_PORT_RANGE_MAX    (LMS_SAMPLE_LOOP_START_PORT_RANGE_MIN + EUPHORIA_MAX_SAMPLE_COUNT)

#define LMS_SAMPLE_LOOP_END_PORT_RANGE_MIN    LMS_SAMPLE_LOOP_START_PORT_RANGE_MAX
#define LMS_SAMPLE_LOOP_END_PORT_RANGE_MAX    (LMS_SAMPLE_LOOP_END_PORT_RANGE_MIN + EUPHORIA_MAX_SAMPLE_COUNT)

#define LMS_SAMPLE_LOOP_MODE_PORT_RANGE_MIN    LMS_SAMPLE_LOOP_END_PORT_RANGE_MAX
#define LMS_SAMPLE_LOOP_MODE_PORT_RANGE_MAX    (LMS_SAMPLE_LOOP_MODE_PORT_RANGE_MIN + EUPHORIA_MAX_SAMPLE_COUNT)

//MonoFX0
#define LMS_MONO_FX0_KNOB0_PORT_RANGE_MIN    LMS_SAMPLE_LOOP_MODE_PORT_RANGE_MAX
#define LMS_MONO_FX0_KNOB0_PORT_RANGE_MAX    (LMS_MONO_FX0_KNOB0_PORT_RANGE_MIN + EUPHORIA_MONO_FX_GROUPS_COUNT)

#define LMS_MONO_FX0_KNOB1_PORT_RANGE_MIN    LMS_MONO_FX0_KNOB0_PORT_RANGE_MAX
#define LMS_MONO_FX0_KNOB1_PORT_RANGE_MAX    (LMS_MONO_FX0_KNOB1_PORT_RANGE_MIN + EUPHORIA_MONO_FX_GROUPS_COUNT)

#define LMS_MONO_FX0_KNOB2_PORT_RANGE_MIN    LMS_MONO_FX0_KNOB1_PORT_RANGE_MAX
#define LMS_MONO_FX0_KNOB2_PORT_RANGE_MAX    (LMS_MONO_FX0_KNOB2_PORT_RANGE_MIN + EUPHORIA_MONO_FX_GROUPS_COUNT)

#define LMS_MONO_FX0_COMBOBOX_PORT_RANGE_MIN    LMS_MONO_FX0_KNOB2_PORT_RANGE_MAX
#define LMS_MONO_FX0_COMBOBOX_PORT_RANGE_MAX    (LMS_MONO_FX0_COMBOBOX_PORT_RANGE_MIN + EUPHORIA_MONO_FX_GROUPS_COUNT)
//MonoFX1
#define LMS_MONO_FX1_KNOB0_PORT_RANGE_MIN    LMS_MONO_FX0_COMBOBOX_PORT_RANGE_MAX
#define LMS_MONO_FX1_KNOB0_PORT_RANGE_MAX    (LMS_MONO_FX1_KNOB0_PORT_RANGE_MIN + EUPHORIA_MONO_FX_GROUPS_COUNT)

#define LMS_MONO_FX1_KNOB1_PORT_RANGE_MIN    LMS_MONO_FX1_KNOB0_PORT_RANGE_MAX
#define LMS_MONO_FX1_KNOB1_PORT_RANGE_MAX    (LMS_MONO_FX1_KNOB1_PORT_RANGE_MIN + EUPHORIA_MONO_FX_GROUPS_COUNT)

#define LMS_MONO_FX1_KNOB2_PORT_RANGE_MIN    LMS_MONO_FX1_KNOB1_PORT_RANGE_MAX
#define LMS_MONO_FX1_KNOB2_PORT_RANGE_MAX    (LMS_MONO_FX1_KNOB2_PORT_RANGE_MIN + EUPHORIA_MONO_FX_GROUPS_COUNT)

#define LMS_MONO_FX1_COMBOBOX_PORT_RANGE_MIN    LMS_MONO_FX1_KNOB2_PORT_RANGE_MAX
#define LMS_MONO_FX1_COMBOBOX_PORT_RANGE_MAX    (LMS_MONO_FX1_COMBOBOX_PORT_RANGE_MIN + EUPHORIA_MONO_FX_GROUPS_COUNT)
//MonoFX2
#define LMS_MONO_FX2_KNOB0_PORT_RANGE_MIN    LMS_MONO_FX1_COMBOBOX_PORT_RANGE_MAX
#define LMS_MONO_FX2_KNOB0_PORT_RANGE_MAX    (LMS_MONO_FX2_KNOB0_PORT_RANGE_MIN + EUPHORIA_MONO_FX_GROUPS_COUNT)

#define LMS_MONO_FX2_KNOB1_PORT_RANGE_MIN    LMS_MONO_FX2_KNOB0_PORT_RANGE_MAX
#define LMS_MONO_FX2_KNOB1_PORT_RANGE_MAX    (LMS_MONO_FX2_KNOB1_PORT_RANGE_MIN + EUPHORIA_MONO_FX_GROUPS_COUNT)

#define LMS_MONO_FX2_KNOB2_PORT_RANGE_MIN    LMS_MONO_FX2_KNOB1_PORT_RANGE_MAX
#define LMS_MONO_FX2_KNOB2_PORT_RANGE_MAX    (LMS_MONO_FX2_KNOB2_PORT_RANGE_MIN + EUPHORIA_MONO_FX_GROUPS_COUNT)

#define LMS_MONO_FX2_COMBOBOX_PORT_RANGE_MIN    LMS_MONO_FX2_KNOB2_PORT_RANGE_MAX
#define LMS_MONO_FX2_COMBOBOX_PORT_RANGE_MAX    (LMS_MONO_FX2_COMBOBOX_PORT_RANGE_MIN + EUPHORIA_MONO_FX_GROUPS_COUNT)
//MonoFX3
#define LMS_MONO_FX3_KNOB0_PORT_RANGE_MIN    LMS_MONO_FX2_COMBOBOX_PORT_RANGE_MAX
#define LMS_MONO_FX3_KNOB0_PORT_RANGE_MAX    (LMS_MONO_FX3_KNOB0_PORT_RANGE_MIN + EUPHORIA_MONO_FX_GROUPS_COUNT)

#define LMS_MONO_FX3_KNOB1_PORT_RANGE_MIN    LMS_MONO_FX3_KNOB0_PORT_RANGE_MAX
#define LMS_MONO_FX3_KNOB1_PORT_RANGE_MAX    (LMS_MONO_FX3_KNOB1_PORT_RANGE_MIN + EUPHORIA_MONO_FX_GROUPS_COUNT)

#define LMS_MONO_FX3_KNOB2_PORT_RANGE_MIN    LMS_MONO_FX3_KNOB1_PORT_RANGE_MAX
#define LMS_MONO_FX3_KNOB2_PORT_RANGE_MAX    (LMS_MONO_FX3_KNOB2_PORT_RANGE_MIN + EUPHORIA_MONO_FX_GROUPS_COUNT)

#define LMS_MONO_FX3_COMBOBOX_PORT_RANGE_MIN    LMS_MONO_FX3_KNOB2_PORT_RANGE_MAX
#define LMS_MONO_FX3_COMBOBOX_PORT_RANGE_MAX    (LMS_MONO_FX3_COMBOBOX_PORT_RANGE_MIN + EUPHORIA_MONO_FX_GROUPS_COUNT)
//Sample FX Group
#define LMS_SAMPLE_MONO_FX_GROUP_PORT_RANGE_MIN    LMS_MONO_FX3_COMBOBOX_PORT_RANGE_MAX
#define LMS_SAMPLE_MONO_FX_GROUP_PORT_RANGE_MAX    (LMS_SAMPLE_MONO_FX_GROUP_PORT_RANGE_MIN + EUPHORIA_MAX_SAMPLE_COUNT)

#define Sampler_Stereo_COUNT                LMS_SAMPLE_MONO_FX_GROUP_PORT_RANGE_MAX
