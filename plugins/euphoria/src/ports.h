...
#define LMS_MONO_FX0_KNOB0_PORT_RANGE_MAX    (LMS_MONO_FX0_KNOB0_PORT_RANGE_MIN + LMS_MONO_FX_GROUPS_COUNT)

#define LMS_MONO_FX0_KNOB1_PORT_RANGE_MIN    LMS_MONO_FX0_KNOB0_PORT_RANGE_MAX
#define LMS_MONO_FX0_KNOB1_PORT_RANGE_MAX    (LMS_MONO_FX0_KNOB1_PORT_RANGE_MIN + LMS_MONO_FX_GROUPS_COUNT)

#define LMS_MONO_FX0_KNOB2_PORT_RANGE_MIN    LMS_MONO_FX0_KNOB1_PORT_RANGE_MAX
#define LMS_MONO_FX0_KNOB2_PORT_RANGE_MAX    (LMS_MONO_FX0_KNOB2_PORT_RANGE_MIN + LMS_MONO_FX_GROUPS_COUNT)

#define LMS_MONO_FX0_COMBOBOX_PORT_RANGE_MIN    LMS_MONO_FX0_KNOB2_PORT_RANGE_MAX
#define LMS_MONO_FX0_COMBOBOX_PORT_RANGE_MAX    (LMS_MONO_FX0_COMBOBOX_PORT_RANGE_MIN + LMS_MONO_FX_GROUPS_COUNT)
//MonoFX1
#define LMS_MONO_FX1_KNOB0_PORT_RANGE_MIN    LMS_MONO_FX0_COMBOBOX_PORT_RANGE_MAX
#define LMS_MONO_FX1_KNOB0_PORT_RANGE_MAX    (LMS_MONO_FX1_KNOB0_PORT_RANGE_MIN + LMS_MONO_FX_GROUPS_COUNT)

#define LMS_MONO_FX1_KNOB1_PORT_RANGE_MIN    LMS_MONO_FX1_KNOB0_PORT_RANGE_MAX
#define LMS_MONO_FX1_KNOB1_PORT_RANGE_MAX    (LMS_MONO_FX1_KNOB1_PORT_RANGE_MIN + LMS_MONO_FX_GROUPS_COUNT)

#define LMS_MONO_FX1_KNOB2_PORT_RANGE_MIN    LMS_MONO_FX1_KNOB1_PORT_RANGE_MAX
#define LMS_MONO_FX1_KNOB2_PORT_RANGE_MAX    (LMS_MONO_FX1_KNOB2_PORT_RANGE_MIN + LMS_MONO_FX_GROUPS_COUNT)

#define LMS_MONO_FX1_COMBOBOX_PORT_RANGE_MIN    LMS_MONO_FX1_KNOB2_PORT_RANGE_MAX
#define LMS_MONO_FX1_COMBOBOX_PORT_RANGE_MAX    (LMS_MONO_FX1_COMBOBOX_PORT_RANGE_MIN + LMS_MONO_FX_GROUPS_COUNT)
//MonoFX2
#define LMS_MONO_FX2_KNOB0_PORT_RANGE_MIN    LMS_MONO_FX1_COMBOBOX_PORT_RANGE_MAX
#define LMS_MONO_FX2_KNOB0_PORT_RANGE_MAX    (LMS_MONO_FX2_KNOB0_PORT_RANGE_MIN + LMS_MONO_FX_GROUPS_COUNT)

#define LMS_MONO_FX2_KNOB1_PORT_RANGE_MIN    LMS_MONO_FX2_KNOB0_PORT_RANGE_MAX
#define LMS_MONO_FX2_KNOB1_PORT_RANGE_MAX    (LMS_MONO_FX2_KNOB1_PORT_RANGE_MIN + LMS_MONO_FX_GROUPS_COUNT)

#define LMS_MONO_FX2_KNOB2_PORT_RANGE_MIN    LMS_MONO_FX2_KNOB1_PORT_RANGE_MAX
#define LMS_MONO_FX2_KNOB2_PORT_RANGE_MAX    (LMS_MONO_FX2_KNOB2_PORT_RANGE_MIN + LMS_MONO_FX_GROUPS_COUNT)

#define LMS_MONO_FX2_COMBOBOX_PORT_RANGE_MIN    LMS_MONO_FX2_KNOB2_PORT_RANGE_MAX
#define LMS_MONO_FX2_COMBOBOX_PORT_RANGE_MAX    (LMS_MONO_FX2_COMBOBOX_PORT_RANGE_MIN + LMS_MONO_FX_GROUPS_COUNT)
//MonoFX3
#define LMS_MONO_FX3_KNOB0_PORT_RANGE_MIN    LMS_MONO_FX2_COMBOBOX_PORT_RANGE_MAX
#define LMS_MONO_FX3_KNOB0_PORT_RANGE_MAX    (LMS_MONO_FX3_KNOB0_PORT_RANGE_MIN + LMS_MONO_FX_GROUPS_COUNT)

#define LMS_MONO_FX3_KNOB1_PORT_RANGE_MIN    LMS_MONO_FX3_KNOB0_PORT_RANGE_MAX
#define LMS_MONO_FX3_KNOB1_PORT_RANGE_MAX    (LMS_MONO_FX3_KNOB1_PORT_RANGE_MIN + LMS_MONO_FX_GROUPS_COUNT)

#define LMS_MONO_FX3_KNOB2_PORT_RANGE_MIN    LMS_MONO_FX3_KNOB1_PORT_RANGE_MAX
#define LMS_MONO_FX3_KNOB2_PORT_RANGE_MAX    (LMS_MONO_FX3_KNOB2_PORT_RANGE_MIN + LMS_MONO_FX_GROUPS_COUNT)

#define LMS_MONO_FX3_COMBOBOX_PORT_RANGE_MIN    LMS_MONO_FX3_KNOB2_PORT_RANGE_MAX
#define LMS_MONO_FX3_COMBOBOX_PORT_RANGE_MAX    (LMS_MONO_FX3_COMBOBOX_PORT_RANGE_MIN + LMS_MONO_FX_GROUPS_COUNT)
//Sample FX Group
#define LMS_SAMPLE_MONO_FX_GROUP_PORT_RANGE_MIN    LMS_MONO_FX3_COMBOBOX_PORT_RANGE_MAX
#define LMS_SAMPLE_MONO_FX_GROUP_PORT_RANGE_MAX    (LMS_SAMPLE_MONO_FX_GROUP_PORT_RANGE_MIN + LMS_MAX_SAMPLE_COUNT)
