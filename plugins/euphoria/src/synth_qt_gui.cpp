    ...
    m_ready(false)
{
    ...
    m_file_selector = new LMS_file_select(this);
        ...
        actionMapToMonoFX = new QAction(this);                
        ...
        actionMapToMonoFX->setText(QString("Map All Samples to Own MonoFX Group"));
        ...
        connect(actionMapToMonoFX, SIGNAL(triggered()), this, SLOT(mapAllSamplesToOneMonoFXgroup()));
        connect(actionClearAllSamples, SIGNAL(triggered()), this, SLOT(clearAllSamples()));
        
        /*synth_qt_gui.cpp Autogenerated connections*/
        connect(((LMS_note_selector*)(m_sample_table->lms_mm_columns[SMP_TB_NOTE_INDEX]->controls[0]))->lms_note, SIGNAL(currentIndexChanged(int)), this, SLOT(sample_note0Changed(int)));
        connect(((LMS_note_selector*)(m_sample_table->lms_mm_columns[SMP_TB_NOTE_INDEX]->controls[0]))->lms_octave, SIGNAL(valueChanged(int)), this, SLOT(sample_note0Changed(int)));
        connect(((LMS_note_selector*)(m_sample_table->lms_mm_columns[SMP_TB_NOTE_INDEX]->controls[1]))->lms_note, SIGNAL(currentIndexChanged(int)), this, SLOT(sample_note1Changed(int)));
        connect(((LMS_note_selector*)(m_sample_table->lms_mm_columns[SMP_TB_NOTE_INDEX]->controls[1]))->lms_octave, SIGNAL(valueChanged(int)), this, SLOT(sample_note1Changed(int)));
        connect(((LMS_note_selector*)(m_sample_table->lms_mm_columns[SMP_TB_NOTE_INDEX]->controls[2]))->lms_note, SIGNAL(currentIndexChanged(int)), this, SLOT(sample_note2Changed(int)));
        connect(((LMS_note_selector*)(m_sample_table->lms_mm_columns[SMP_TB_NOTE_INDEX]->controls[2]))->lms_octave, SIGNAL(valueChanged(int)), this, SLOT(sample_note2Changed(int)));
        connect(((LMS_note_selector*)(m_sample_table->lms_mm_columns[SMP_TB_NOTE_INDEX]->controls[3]))->lms_note, SIGNAL(currentIndexChanged(int)), this, SLOT(sample_note3Changed(int)));
        connect(((LMS_note_selector*)(m_sample_table->lms_mm_columns[SMP_TB_NOTE_INDEX]->controls[3]))->lms_octave, SIGNAL(valueChanged(int)), this, SLOT(sample_note3Changed(int)));
        connect(((LMS_note_selector*)(m_sample_table->lms_mm_columns[SMP_TB_NOTE_INDEX]->controls[4]))->lms_note, SIGNAL(currentIndexChanged(int)), this, SLOT(sample_note4Changed(int)));
        connect(((LMS_note_selector*)(m_sample_table->lms_mm_columns[SMP_TB_NOTE_INDEX]->controls[4]))->lms_octave, SIGNAL(valueChanged(int)), this, SLOT(sample_note4Changed(int)));
        connect(((LMS_note_selector*)(m_sample_table->lms_mm_columns[SMP_TB_NOTE_INDEX]->controls[5]))->lms_note, SIGNAL(currentIndexChanged(int)), this, SLOT(sample_note5Changed(int)));
        connect(((LMS_note_selector*)(m_sample_table->lms_mm_columns[SMP_TB_NOTE_INDEX]->controls[5]))->lms_octave, SIGNAL(valueChanged(int)), this, SLOT(sample_note5Changed(int)));
        connect(((LMS_note_selector*)(m_sample_table->lms_mm_columns[SMP_TB_NOTE_INDEX]->controls[6]))->lms_note, SIGNAL(currentIndexChanged(int)), this, SLOT(sample_note6Changed(int)));
        connect(((LMS_note_selector*)(m_sample_table->lms_mm_columns[SMP_TB_NOTE_INDEX]->controls[6]))->lms_octave, SIGNAL(valueChanged(int)), this, SLOT(sample_note6Changed(int)));
        connect(((LMS_note_selector*)(m_sample_table->lms_mm_columns[SMP_TB_NOTE_INDEX]->controls[7]))->lms_note, SIGNAL(currentIndexChanged(int)), this, SLOT(sample_note7Changed(int)));
        connect(((LMS_note_selector*)(m_sample_table->lms_mm_columns[SMP_TB_NOTE_INDEX]->controls[7]))->lms_octave, SIGNAL(valueChanged(int)), this, SLOT(sample_note7Changed(int)));
        connect(((LMS_note_selector*)(m_sample_table->lms_mm_columns[SMP_TB_NOTE_INDEX]->controls[8]))->lms_note, SIGNAL(currentIndexChanged(int)), this, SLOT(sample_note8Changed(int)));
        connect(((LMS_note_selector*)(m_sample_table->lms_mm_columns[SMP_TB_NOTE_INDEX]->controls[8]))->lms_octave, SIGNAL(valueChanged(int)), this, SLOT(sample_note8Changed(int)));
        connect(((LMS_note_selector*)(m_sample_table->lms_mm_columns[SMP_TB_NOTE_INDEX]->controls[9]))->lms_note, SIGNAL(currentIndexChanged(int)), this, SLOT(sample_note9Changed(int)));
        connect(((LMS_note_selector*)(m_sample_table->lms_mm_columns[SMP_TB_NOTE_INDEX]->controls[9]))->lms_octave, SIGNAL(valueChanged(int)), this, SLOT(sample_note9Changed(int)));
        connect(((LMS_note_selector*)(m_sample_table->lms_mm_columns[SMP_TB_NOTE_INDEX]->controls[10]))->lms_note, SIGNAL(currentIndexChanged(int)), this, SLOT(sample_note10Changed(int)));
        connect(((LMS_note_selector*)(m_sample_table->lms_mm_columns[SMP_TB_NOTE_INDEX]->controls[10]))->lms_octave, SIGNAL(valueChanged(int)), this, SLOT(sample_note10Changed(int)));
        connect(((LMS_note_selector*)(m_sample_table->lms_mm_columns[SMP_TB_NOTE_INDEX]->controls[11]))->lms_note, SIGNAL(currentIndexChanged(int)), this, SLOT(sample_note11Changed(int)));
        connect(((LMS_note_selector*)(m_sample_table->lms_mm_columns[SMP_TB_NOTE_INDEX]->controls[11]))->lms_octave, SIGNAL(valueChanged(int)), this, SLOT(sample_note11Changed(int)));
        connect(((LMS_note_selector*)(m_sample_table->lms_mm_columns[SMP_TB_NOTE_INDEX]->controls[12]))->lms_note, SIGNAL(currentIndexChanged(int)), this, SLOT(sample_note12Changed(int)));
        connect(((LMS_note_selector*)(m_sample_table->lms_mm_columns[SMP_TB_NOTE_INDEX]->controls[12]))->lms_octave, SIGNAL(valueChanged(int)), this, SLOT(sample_note12Changed(int)));
        connect(((LMS_note_selector*)(m_sample_table->lms_mm_columns[SMP_TB_NOTE_INDEX]->controls[13]))->lms_note, SIGNAL(currentIndexChanged(int)), this, SLOT(sample_note13Changed(int)));
        connect(((LMS_note_selector*)(m_sample_table->lms_mm_columns[SMP_TB_NOTE_INDEX]->controls[13]))->lms_octave, SIGNAL(valueChanged(int)), this, SLOT(sample_note13Changed(int)));
        connect(((LMS_note_selector*)(m_sample_table->lms_mm_columns[SMP_TB_NOTE_INDEX]->controls[14]))->lms_note, SIGNAL(currentIndexChanged(int)), this, SLOT(sample_note14Changed(int)));
        connect(((LMS_note_selector*)(m_sample_table->lms_mm_columns[SMP_TB_NOTE_INDEX]->controls[14]))->lms_octave, SIGNAL(valueChanged(int)), this, SLOT(sample_note14Changed(int)));
        connect(((LMS_note_selector*)(m_sample_table->lms_mm_columns[SMP_TB_NOTE_INDEX]->controls[15]))->lms_note, SIGNAL(currentIndexChanged(int)), this, SLOT(sample_note15Changed(int)));
        connect(((LMS_note_selector*)(m_sample_table->lms_mm_columns[SMP_TB_NOTE_INDEX]->controls[15]))->lms_octave, SIGNAL(valueChanged(int)), this, SLOT(sample_note15Changed(int)));
        connect(((LMS_note_selector*)(m_sample_table->lms_mm_columns[SMP_TB_NOTE_INDEX]->controls[16]))->lms_note, SIGNAL(currentIndexChanged(int)), this, SLOT(sample_note16Changed(int)));
        connect(((LMS_note_selector*)(m_sample_table->lms_mm_columns[SMP_TB_NOTE_INDEX]->controls[16]))->lms_octave, SIGNAL(valueChanged(int)), this, SLOT(sample_note16Changed(int)));
        connect(((LMS_note_selector*)(m_sample_table->lms_mm_columns[SMP_TB_NOTE_INDEX]->controls[17]))->lms_note, SIGNAL(currentIndexChanged(int)), this, SLOT(sample_note17Changed(int)));
        connect(((LMS_note_selector*)(m_sample_table->lms_mm_columns[SMP_TB_NOTE_INDEX]->controls[17]))->lms_octave, SIGNAL(valueChanged(int)), this, SLOT(sample_note17Changed(int)));
        connect(((LMS_note_selector*)(m_sample_table->lms_mm_columns[SMP_TB_NOTE_INDEX]->controls[18]))->lms_note, SIGNAL(currentIndexChanged(int)), this, SLOT(sample_note18Changed(int)));
        connect(((LMS_note_selector*)(m_sample_table->lms_mm_columns[SMP_TB_NOTE_INDEX]->controls[18]))->lms_octave, SIGNAL(valueChanged(int)), this, SLOT(sample_note18Changed(int)));
        connect(((LMS_note_selector*)(m_sample_table->lms_mm_columns[SMP_TB_NOTE_INDEX]->controls[19]))->lms_note, SIGNAL(currentIndexChanged(int)), this, SLOT(sample_note19Changed(int)));
        connect(((LMS_note_selector*)(m_sample_table->lms_mm_columns[SMP_TB_NOTE_INDEX]->controls[19]))->lms_octave, SIGNAL(valueChanged(int)), this, SLOT(sample_note19Changed(int)));
        connect(((LMS_note_selector*)(m_sample_table->lms_mm_columns[SMP_TB_NOTE_INDEX]->controls[20]))->lms_note, SIGNAL(currentIndexChanged(int)), this, SLOT(sample_note20Changed(int)));
        connect(((LMS_note_selector*)(m_sample_table->lms_mm_columns[SMP_TB_NOTE_INDEX]->controls[20]))->lms_octave, SIGNAL(valueChanged(int)), this, SLOT(sample_note20Changed(int)));
        connect(((LMS_note_selector*)(m_sample_table->lms_mm_columns[SMP_TB_NOTE_INDEX]->controls[21]))->lms_note, SIGNAL(currentIndexChanged(int)), this, SLOT(sample_note21Changed(int)));
        connect(((LMS_note_selector*)(m_sample_table->lms_mm_columns[SMP_TB_NOTE_INDEX]->controls[21]))->lms_octave, SIGNAL(valueChanged(int)), this, SLOT(sample_note21Changed(int)));
        connect(((LMS_note_selector*)(m_sample_table->lms_mm_columns[SMP_TB_NOTE_INDEX]->controls[22]))->lms_note, SIGNAL(currentIndexChanged(int)), this, SLOT(sample_note22Changed(int)));
        connect(((LMS_note_selector*)(m_sample_table->lms_mm_columns[SMP_TB_NOTE_INDEX]->controls[22]))->lms_octave, SIGNAL(valueChanged(int)), this, SLOT(sample_note22Changed(int)));
        connect(((LMS_note_selector*)(m_sample_table->lms_mm_columns[SMP_TB_NOTE_INDEX]->controls[23]))->lms_note, SIGNAL(currentIndexChanged(int)), this, SLOT(sample_note23Changed(int)));
        connect(((LMS_note_selector*)(m_sample_table->lms_mm_columns[SMP_TB_NOTE_INDEX]->controls[23]))->lms_octave, SIGNAL(valueChanged(int)), this, SLOT(sample_note23Changed(int)));
        connect(((LMS_note_selector*)(m_sample_table->lms_mm_columns[SMP_TB_NOTE_INDEX]->controls[24]))->lms_note, SIGNAL(currentIndexChanged(int)), this, SLOT(sample_note24Changed(int)));
        connect(((LMS_note_selector*)(m_sample_table->lms_mm_columns[SMP_TB_NOTE_INDEX]->controls[24]))->lms_octave, SIGNAL(valueChanged(int)), this, SLOT(sample_note24Changed(int)));
        connect(((LMS_note_selector*)(m_sample_table->lms_mm_columns[SMP_TB_NOTE_INDEX]->controls[25]))->lms_note, SIGNAL(currentIndexChanged(int)), this, SLOT(sample_note25Changed(int)));
        connect(((LMS_note_selector*)(m_sample_table->lms_mm_columns[SMP_TB_NOTE_INDEX]->controls[25]))->lms_octave, SIGNAL(valueChanged(int)), this, SLOT(sample_note25Changed(int)));
        connect(((LMS_note_selector*)(m_sample_table->lms_mm_columns[SMP_TB_NOTE_INDEX]->controls[26]))->lms_note, SIGNAL(currentIndexChanged(int)), this, SLOT(sample_note26Changed(int)));
        connect(((LMS_note_selector*)(m_sample_table->lms_mm_columns[SMP_TB_NOTE_INDEX]->controls[26]))->lms_octave, SIGNAL(valueChanged(int)), this, SLOT(sample_note26Changed(int)));
        connect(((LMS_note_selector*)(m_sample_table->lms_mm_columns[SMP_TB_NOTE_INDEX]->controls[27]))->lms_note, SIGNAL(currentIndexChanged(int)), this, SLOT(sample_note27Changed(int)));
        connect(((LMS_note_selector*)(m_sample_table->lms_mm_columns[SMP_TB_NOTE_INDEX]->controls[27]))->lms_octave, SIGNAL(valueChanged(int)), this, SLOT(sample_note27Changed(int)));
        connect(((LMS_note_selector*)(m_sample_table->lms_mm_columns[SMP_TB_NOTE_INDEX]->controls[28]))->lms_note, SIGNAL(currentIndexChanged(int)), this, SLOT(sample_note28Changed(int)));
        connect(((LMS_note_selector*)(m_sample_table->lms_mm_columns[SMP_TB_NOTE_INDEX]->controls[28]))->lms_octave, SIGNAL(valueChanged(int)), this, SLOT(sample_note28Changed(int)));
        connect(((LMS_note_selector*)(m_sample_table->lms_mm_columns[SMP_TB_NOTE_INDEX]->controls[29]))->lms_note, SIGNAL(currentIndexChanged(int)), this, SLOT(sample_note29Changed(int)));
        connect(((LMS_note_selector*)(m_sample_table->lms_mm_columns[SMP_TB_NOTE_INDEX]->controls[29]))->lms_octave, SIGNAL(valueChanged(int)), this, SLOT(sample_note29Changed(int)));
        connect(((LMS_note_selector*)(m_sample_table->lms_mm_columns[SMP_TB_NOTE_INDEX]->controls[30]))->lms_note, SIGNAL(currentIndexChanged(int)), this, SLOT(sample_note30Changed(int)));
        connect(((LMS_note_selector*)(m_sample_table->lms_mm_columns[SMP_TB_NOTE_INDEX]->controls[30]))->lms_octave, SIGNAL(valueChanged(int)), this, SLOT(sample_note30Changed(int)));
        connect(((LMS_note_selector*)(m_sample_table->lms_mm_columns[SMP_TB_NOTE_INDEX]->controls[31]))->lms_note, SIGNAL(currentIndexChanged(int)), this, SLOT(sample_note31Changed(int)));
        connect(((LMS_note_selector*)(m_sample_table->lms_mm_columns[SMP_TB_NOTE_INDEX]->controls[31]))->lms_octave, SIGNAL(valueChanged(int)), this, SLOT(sample_note31Changed(int)));
...
/*End synth_qt_gui.cpp Autogenerated connections*/
        ...
        in ~/pydaw .  If modifying this plugin by changing the number of parameters to be saved by presets, you should comment this out
        ...
        connect(m_mono_fx_tab_selected_group, SIGNAL(currentIndexChanged(int)), this, SLOT(sample_selected_monofx_groupChanged(int)));
...
void SamplerGUI::mapAllSamplesToOneMonoFXgroup()
{
    int f_i;
    int f_orig_index = m_mono_fx_tab_selected_sample->currentIndex();
        
    for(f_i = 0; f_i < EUPHORIA_MAX_SAMPLE_COUNT; f_i++ )
    {
        m_mono_fx_tab_selected_sample->setCurrentIndex(f_i);
        m_mono_fx_tab_selected_group->setCurrentIndex(f_i);
    }
    
    m_mono_fx_tab_selected_sample->setCurrentIndex(f_orig_index);
}
...
{    
    ...
    setSelectedMonoFX(m_sample_selected_monofx_groups[((m_sample_table->lms_selected_column))]);
...
{    
    ...
    setmonoFX0combobox(m_mono_fx_values[a_value][0][3]);
    
    setmonoFX1knob0(m_mono_fx_values[a_value][1][0]);
    setmonoFX1knob1(m_mono_fx_values[a_value][1][1]);
    setmonoFX1knob2(m_mono_fx_values[a_value][1][2]);
    setmonoFX1combobox(m_mono_fx_values[a_value][1][3]);
    
    setmonoFX2knob0(m_mono_fx_values[a_value][2][0]);
    setmonoFX2knob1(m_mono_fx_values[a_value][2][1]);
    setmonoFX2knob2(m_mono_fx_values[a_value][2][2]);
    setmonoFX2combobox(m_mono_fx_values[a_value][2][3]);
    
    setmonoFX3knob0(m_mono_fx_values[a_value][3][0]);
    setmonoFX3knob1(m_mono_fx_values[a_value][3][1]);
