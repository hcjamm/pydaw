...
#define LMS_SINC_INTERPOLATION_POINTS 33
#define LMS_SINC_INTERPOLATION_POINTS_DIV2 16
...
t_mono_modules * g_mono_init()
{
    ...
    a_mono->sinc_interpolator = g_sinc_get(LMS_SINC_INTERPOLATION_POINTS, 200,0.25f);
    return a_mono;
}
