		  ...
		  snd_seq_event_t *events, unsigned long event_count)
{
    ...
    /*Define our inputs*/
    LADSPA_Data *const input0 = g_dbg_get_input_buffer((plugin_data->count), 66.0f, -1);
    LADSPA_Data *const input1 = g_dbg_get_input_buffer((plugin_data->count), 66.0f, -1);
    /*define our outputs*/
