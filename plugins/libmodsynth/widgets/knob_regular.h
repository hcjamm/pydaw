...
{    
    ...
    public:
        ...
        QString a_label_value, LMS_KNOB_CONVERSION a_conv_type, QWidget *a_parent, bool * a_suppressHostUpdate, 
                int a_lms_port, lo_address a_host, QByteArray a_controlPath)
        {
