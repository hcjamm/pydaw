...
public:
    ...
    LMS_file_select(QWidget * a_parent)
    {
        ...
        QString f_global_config_path(QDir::homePath() + QString("/pydaw2/lms_global_wave_editor.txt"));
    ...
    void open_in_editor_button_pressed(QWidget * a_parent)
    {
        if(!QFile::exists(lms_editor_path))
        {
            ...
            QString(" or another suitable wave editor.  Please edit ~/pydaw2/lms_global_wave_editor.txt with your wave editor of choice, or install Audacity."));
            return;
        }
