...
Architecture: %s
Version: %s
Depends: liblo-dev, libsndfile1-dev, libportmidi-dev, portaudio19-dev, python-liblo, python-qt4, audacity, python2.7, libmad0-dev, python-scipy, python-numpy, libsamplerate0-dev, libfftw3-dev
Provides: %s
Conflicts:
Replaces:
