...
Architecture: %s
Version: %s
Depends: liblo-dev, libsndfile1-dev, libportmidi-dev, python3-pyqt4, audacity, python3, libmad0-dev, python3-scipy, python3-numpy, libsamplerate0-dev, libfftw3-dev
Provides: %s
Conflicts:
Replaces:
