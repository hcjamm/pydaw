...
$deps_ubuntu = "sudo apt-get install -y python-pyaudio portaudio19-dev liblo-dev libasound2-dev g++ libsndfile1-dev libtool gdb debhelper dh-make build-essential automake autoconf alsa-utils python-liblo python-qt4 python2.7 squashfs-tools genisoimage libmad0-dev python-scipy python-numpy libsamplerate0-dev vamp-plugin-sdk ladspa-sdk libfftw3-dev gcc";
