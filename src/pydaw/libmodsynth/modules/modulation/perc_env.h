...
t_pnv_perc_env * g_pnv_get(float);
void v_pnv_set(t_pnv_perc_env*, float, float, float, float, float);
float f_pnv_run(t_pnv_perc_env*);

/*
 * void v_pnv_set(t_pnv_perc_env* a_pnv, float a_t1, float a_p1,
...
float f_pnv_run(t_pnv_perc_env * a_pnv)
{
