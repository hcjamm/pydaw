...
class pydaw_wave_editor_widget:
    def __init__(self):
        ...
        self.edit_hlayout.addLayout(self.gridlayout)
        ...
        self.gridlayout.addWidget(QtGui.QLabel(_("Fade-In")), 0, 0)
        self.gridlayout.addWidget(self.fade_in_start, 0, 1)
        ...
        self.gridlayout.addWidget(QtGui.QLabel(_("Fade-Out")), 1, 0)
        self.gridlayout.addWidget(self.fade_out_end, 1, 1)
