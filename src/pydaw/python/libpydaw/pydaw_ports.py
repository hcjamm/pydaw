...
WAYV_PORT_MAP = [
    ("Master Attack", WAYV_ATTACK_MAIN, "2", "0.0", "200.0"),
    ("Master Hold", WAYV_HOLD_MAIN, "2", "0.0", "200.0"),
    ("Master Decay", WAYV_DECAY_MAIN, "2", "10.0", "200.0"),
    ("Master Sustain", WAYV_SUSTAIN_MAIN, "0", "-30.0", "0.0"),
    ("Master Release", WAYV_RELEASE_MAIN, "2", "10.0", "400.0"),
    ("Noise Amp", "6", "0", "-60.0", "0.0"),
    ("Master Glide", "18", "2", "0.0", "200.0"),
    ("Osc1 Attack", WAYV_ATTACK1, "2", "0.0", "200.0"),
    ("Osc1 Decay", WAYV_DECAY1, "2", "10.0", "200.0"),
    ("Osc1 Sustain", WAYV_SUSTAIN1, "0", "-30.0", "0.0"),
    ("Osc1 Release", WAYV_RELEASE1, "2", "10.0", "400.0"),
    ("Osc2 Attack", WAYV_ATTACK2, "2", "10.0", "200.0"),
    ("Osc2 Decay", WAYV_DECAY2, "2", "10.0", "200.0"),
    ("Osc2 Sustain", WAYV_SUSTAIN2, "0", "-30.0", "0.0"),
    ("Osc2 Release", WAYV_RELEASE2, "2", "10.0", "400.0"),
    ("PFX ADSR1 Attack", "28", "2", "10.0", "200.0"),
    ("PFX ADSR1 Decay", "29", "2", "10.0", "200.0"),
    ("PFX ADSR1 Sustain", "30", "0", "-60.0", "0.0"),
    ("PFX ADSR1 Release", "31", "2", "10.0", "400.0"),
    ("PFX ADSR2 Attack", "32", "2", "10.0", "200.0"),
    ("PFX ADSR2 Decay", "33", "2", "10.0", "200.0"),
    ("PFX ADSR2 Sustain", "34", "2", "0.0", "100.0"),
    ("PFX ADSR2 Release", "35", "2", "10.0", "400.0"),
    ...
    ("Osc1 FM1", WAYV_OSC1_FM1, "0", "0.0", "100.0"),
    ("Osc1 FM2", WAYV_OSC1_FM2, "0", "0.0", "100.0"),
    ("Osc1 FM3", WAYV_OSC1_FM3, "0", "0.0", "100.0"),
    ("Osc1 FM4", WAYV_OSC1_FM4, "0", "0.0", "100.0"),
    ("Osc1 FM5", WAYV_OSC1_FM5, "0", "0.0", "100.0"),
    ("Osc1 FM6", WAYV_OSC1_FM6, "0", "0.0", "100.0"),
    ("Osc2 FM1", WAYV_OSC2_FM1, "0", "0.0", "100.0"),
    ("Osc2 FM2", WAYV_OSC2_FM2, "0", "0.0", "100.0"),
    ("Osc2 FM3", WAYV_OSC2_FM3, "0", "0.0", "100.0"),
    ("Osc2 FM4", WAYV_OSC2_FM4, "0", "0.0", "100.0"),
    ("Osc2 FM5", WAYV_OSC2_FM5, "0", "0.0", "100.0"),
    ("Osc2 FM6", WAYV_OSC2_FM6, "0", "0.0", "100.0"),
    ("Osc3 FM1", WAYV_OSC3_FM1, "0", "0.0", "100.0"),
    ("Osc3 FM2", WAYV_OSC3_FM2, "0", "0.0", "100.0"),
    ("Osc3 FM3", WAYV_OSC3_FM3, "0", "0.0", "100.0"),
    ("Osc3 FM4", WAYV_OSC3_FM4, "0", "0.0", "100.0"),
    ("Osc3 FM5", WAYV_OSC3_FM5, "0", "0.0", "100.0"),
    ("Osc3 FM6", WAYV_OSC3_FM6, "0", "0.0", "100.0"),
    ("Osc4 FM1", WAYV_OSC4_FM1, "0", "0.0", "100.0"),
    ("Osc4 FM2", WAYV_OSC4_FM2, "0", "0.0", "100.0"),
    ("Osc4 FM3", WAYV_OSC4_FM3, "0", "0.0", "100.0"),
    ("Osc4 FM4", WAYV_OSC4_FM4, "0", "0.0", "100.0"),
    ("Osc4 FM5", WAYV_OSC4_FM5, "0", "0.0", "100.0"),
    ("Osc4 FM6", WAYV_OSC4_FM6, "0", "0.0", "100.0"),
    ("Osc5 FM1", WAYV_OSC5_FM1, "0", "0.0", "100.0"),
    ("Osc5 FM2", WAYV_OSC5_FM2, "0", "0.0", "100.0"),
    ("Osc5 FM3", WAYV_OSC5_FM3, "0", "0.0", "100.0"),
    ("Osc5 FM4", WAYV_OSC5_FM4, "0", "0.0", "100.0"),
    ("Osc5 FM5", WAYV_OSC5_FM5, "0", "0.0", "100.0"),
    ("Osc5 FM6", WAYV_OSC5_FM6, "0", "0.0", "100.0"),
    ("Osc6 FM1", WAYV_OSC6_FM1, "0", "0.0", "100.0"),
    ("Osc6 FM2", WAYV_OSC6_FM2, "0", "0.0", "100.0"),
    ("Osc6 FM3", WAYV_OSC6_FM3, "0", "0.0", "100.0"),
    ("Osc6 FM4", WAYV_OSC6_FM4, "0", "0.0", "100.0"),
    ("Osc6 FM5", WAYV_OSC6_FM5, "0", "0.0", "100.0"),
    ("Osc6 FM6", WAYV_OSC6_FM6, "0", "0.0", "100.0"),
    ("Osc3 Attack", WAYV_ATTACK3, "2", "0.0", "200.0"),
    ("Osc3 Decay", WAYV_DECAY3, "2", "10.0", "200.0"),
    ("Osc3 Sustain", WAYV_SUSTAIN3, "0", "-30.0", "0.0"),
    ("Osc3 Release", WAYV_RELEASE3, "2", "10.0", "400.0"),
    ("FM Macro 1", WAYV_FM_MACRO1, "2", "0.0", "100.0"),
    ("FM Macro 2", WAYV_FM_MACRO2, "2", "0.0", "100.0"),
    ("Osc4 Attack", WAYV_ATTACK4, "2", "0.0", "200.0"),
    ("Osc4 Decay", WAYV_DECAY4, "2", "10.0", "200.0"),
    ("Osc4 Sustain", WAYV_SUSTAIN4, "0", "-30.0", "0.0"),
    ("Osc4 Release", WAYV_RELEASE4, "2", "10.0", "400.0"),
    ("Osc5 Attack", WAYV_ATTACK5, "2", "0.0", "200.0"),
    ("Osc5 Decay", WAYV_DECAY5, "2", "10.0", "200.0"),
    ("Osc5 Sustain", WAYV_SUSTAIN5, "0", "-30.0", "0.0"),
    ("Osc5 Release", WAYV_RELEASE5, "2", "10.0", "400.0"),
    ("Osc6 Attack", WAYV_ATTACK6, "2", "0.0", "200.0"),
    ("Osc6 Decay", WAYV_DECAY6, "2", "10.0", "200.0"),
    ("Osc6 Sustain", WAYV_SUSTAIN6, "0", "-30.0", "0.0"),
    ("Osc6 Release", WAYV_RELEASE6, "2", "10.0", "400.0"),
    ("Osc1 Delay", WAYV_ADSR1_DELAY, "2", "0.0", "200.0"),
    ("Osc2 Delay", WAYV_ADSR2_DELAY, "2", "0.0", "200.0"),
    ("Osc3 Delay", WAYV_ADSR3_DELAY, "2", "0.0", "200.0"),
    ("Osc4 Delay", WAYV_ADSR4_DELAY, "2", "0.0", "200.0"),
    ("Osc5 Delay", WAYV_ADSR5_DELAY, "2", "0.0", "200.0"),
    ("Osc6 Delay", WAYV_ADSR6_DELAY, "2", "0.0", "200.0"),
    ("Osc1 Hold", WAYV_ADSR1_HOLD, "2", "0.0", "200.0"),
    ("Osc2 Hold", WAYV_ADSR2_HOLD, "2", "0.0", "200.0"),
    ("Osc3 Hold", WAYV_ADSR3_HOLD, "2", "0.0", "200.0"),
    ("Osc4 Hold", WAYV_ADSR4_HOLD, "2", "0.0", "200.0"),
    ("Osc5 Hold", WAYV_ADSR5_HOLD, "2", "0.0", "200.0"),
    ("Osc6 Hold", WAYV_ADSR6_HOLD, "2", "0.0", "200.0"),
]

RAYV_PORT_MAP = [
    ("Attack", "2", "2", "10.0", "200.0"),
    ("Decay", "3", "2", "10.0", "200.0"),
    ("Sustain", "4", "0", "-60.0", "0.0"),
    ("Release", "5", "2", "10.0", "400.0"),
    ("Filter Cutoff", "6", "1", "20.0", "124.0"),
    ("Res", "7", "0", "-30.0", "0.0"),
    ("Dist", "8", "0", "-6.0", "36.0"),
    ("Attack Filter", "9", "2", "10.0", "100.0"),
    ("Decay Filter", "10", "2", "10.0", "100.0"),
    ("Sustain Filter", "11", "2", "0.0", "100.0"),
    ("Release Filter", "12", "2", "10.0", "200.0"),
