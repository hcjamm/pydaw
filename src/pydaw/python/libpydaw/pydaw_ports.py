...
EUPHORIA_PORT_COUNT = EUPHORIA_SAMPLE_FADE_OUT_MAX
...
MODULEX_LAST_CONTROL_PORT = 65
MODULEX_COUNT = 66 #must be 1 + highest value above CHANGE THIS IF YOU ADD OR TAKE AWAY ANYTHING
