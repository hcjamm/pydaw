...
//sample fade-in
#define EUPHORIA_SAMPLE_FADE_IN_MIN EUPHORIA_NOISE_TYPE_MAX
#define EUPHORIA_SAMPLE_FADE_IN_MAX (EUPHORIA_SAMPLE_FADE_IN_MIN + EUPHORIA_MAX_SAMPLE_COUNT)

//sample fade-out
#define EUPHORIA_SAMPLE_FADE_OUT_MIN EUPHORIA_SAMPLE_FADE_IN_MAX
#define EUPHORIA_SAMPLE_FADE_OUT_MAX (EUPHORIA_SAMPLE_FADE_OUT_MIN + EUPHORIA_MAX_SAMPLE_COUNT)

#define EUPHORIA_FIRST_EQ_PORT EUPHORIA_SAMPLE_FADE_OUT_MAX

/* Stacked as:
 * 100 *
 *     [freq, bw, gain] * 6
 */
#define EUPHORIA_LAST_EQ_PORT (EUPHORIA_FIRST_EQ_PORT + (18 * 100))

#define EUPHORIA_LFO_PITCH_FINE EUPHORIA_LAST_EQ_PORT
#define EUPHORIA_MIN_NOTE (EUPHORIA_LFO_PITCH_FINE + 1)
#define EUPHORIA_MAX_NOTE (EUPHORIA_MIN_NOTE + 1)

#define EUPHORIA_PORT_COUNT     (EUPHORIA_MAX_NOTE + 1)
